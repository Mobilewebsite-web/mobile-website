          ...
          return (
                    <div className="flex flex-row gap-2 items-center mt-10">
                              {floatingList.map((item, i)=>(
                                        <div key={i} onClick={()=>navigate(item.path)} className="h-45 border-2 border-gray-300 w-1/3 flex items-end bg-center bg-cover bg-no-repeat rounded-xl shadow-md" style={{backgroundImage: `url(${item.img})`}}>
