          ...
          return (
                    <div className="flex flex-row gap-2 items-center mt-10">
                              {floatingList.map((item, i)=>(
                                        <div key={i} className="h-45 border-4 border-white w-1/3 flex items-end bg-center bg-cover bg-no-repeat rounded-xl shadow-lg" style={{backgroundImage: `url(${item.img})`}}>
